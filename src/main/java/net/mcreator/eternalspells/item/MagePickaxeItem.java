...
public class MagePickaxeItem extends EternalSpellsModElements.ModElement {
	@ObjectHolder("eternal_spells:mage_pickaxe")
	public static final Item block = null;
	public MagePickaxeItem(EternalSpellsModElements instance) {
		super(instance, 29);
	}
