...
public class SpellShaperEssenceItem extends EternalSpellsModElements.ModElement {
	@ObjectHolder("eternal_spells:spell_shaper_essence")
	public static final Item block = null;
	public SpellShaperEssenceItem(EternalSpellsModElements instance) {
		super(instance, 7);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("spell_shaper_essence");
		}
