...
public class SpellShaperEssence4Item extends EternalSpellsModElements.ModElement {
	@ObjectHolder("eternal_spells:spell_shaper_essence_4")
	public static final Item block = null;
	public SpellShaperEssence4Item(EternalSpellsModElements instance) {
		super(instance, 10);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("spell_shaper_essence_4");
		}
