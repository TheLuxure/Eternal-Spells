...
public class EssentialTomeItem extends EternalSpellsModElements.ModElement {
	@ObjectHolder("eternal_spells:essential_tome")
	public static final Item block = null;
	public EssentialTomeItem(EternalSpellsModElements instance) {
		super(instance, 19);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("essential_tome");
		}
