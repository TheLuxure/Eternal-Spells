...
public class SpellShaperEssence3Item extends EternalSpellsModElements.ModElement {
	@ObjectHolder("eternal_spells:spell_shaper_essence_3")
	public static final Item block = null;
	public SpellShaperEssence3Item(EternalSpellsModElements instance) {
		super(instance, 9);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("spell_shaper_essence_3");
		}
