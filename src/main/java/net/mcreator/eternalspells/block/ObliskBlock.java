...
public class ObliskBlock extends EternalSpellsModElements.ModElement {
	@ObjectHolder("eternal_spells:oblisk")
	public static final Block block = null;
	public ObliskBlock(EternalSpellsModElements instance) {
		super(instance, 21);
	}
