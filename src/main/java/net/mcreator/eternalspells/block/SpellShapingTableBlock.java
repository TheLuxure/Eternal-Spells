...
import net.mcreator.eternalspells.procedures.SpellShapingTableOnBlockRightClickedProcedure;
...
public class SpellShapingTableBlock extends EternalSpellsModElements.ModElement {
	@ObjectHolder("eternal_spells:spell_shaping_table")
	public static final Block block = null;
	public SpellShapingTableBlock(EternalSpellsModElements instance) {
		super(instance, 5);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("spell_shaping_table");
		}
		...
		public ActionResultType onBlockActivated(BlockState state, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			Direction direction = hit.getFace();
			{
				...
				SpellShapingTableOnBlockRightClickedProcedure.executeProcedure($_dependencies);
			}
