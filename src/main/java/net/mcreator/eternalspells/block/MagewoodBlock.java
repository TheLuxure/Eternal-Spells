...
public class MagewoodBlock extends EternalSpellsModElements.ModElement {
	@ObjectHolder("eternal_spells:magewood")
	public static final Block block = null;
	public MagewoodBlock(EternalSpellsModElements instance) {
		super(instance, 26);
	}
