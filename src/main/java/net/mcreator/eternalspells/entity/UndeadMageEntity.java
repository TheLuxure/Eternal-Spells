...
public class UndeadMageEntity extends EternalSpellsModElements.ModElement {
	public static EntityType entity = null;
	public UndeadMageEntity(EternalSpellsModElements instance) {
		super(instance, 53);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).size(0.6f, 1.8f)).build("undead_mage")
						.setRegistryName("undead_mage");
		elements.entities.add(() -> entity);
		elements.items
				.add(() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(SpellShaperItemGroup.tab)).setRegistryName("undead_mage"));
	}
		...
		RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> {
			BipedRenderer customRender = new BipedRenderer(renderManager, new BipedModel(0), 0.5f) {
				...
				public ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("eternal_spells:textures/mage_layer_1.png");
				}
			};
