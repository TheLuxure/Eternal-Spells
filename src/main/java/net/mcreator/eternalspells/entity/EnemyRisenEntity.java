...
public class EnemyRisenEntity extends EternalSpellsModElements.ModElement {
	public static EntityType entity = null;
	public EnemyRisenEntity(EternalSpellsModElements instance) {
		super(instance, 49);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).size(0.6f, 1.8f)).build("enemy_risen")
						.setRegistryName("enemy_risen");
		elements.entities.add(() -> entity);
		elements.items.add(
				() -> new SpawnEggItem(entity, -16738048, -1, new Item.Properties().group(SpellShaperItemGroup.tab)).setRegistryName("enemy_risen"));
	}
